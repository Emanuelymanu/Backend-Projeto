...
exports.convertCnpj = convertCnpj;
...
function generateBaseAlphanumeric() {
    ...
    for (let i = 0; i < 12; i++) {
        ...
        if (randomChoice) {
            ...
            const letter = constants_1.ALPHABET.charAt(Math.floor(Math.random() * constants_1.ALPHABET.length));
            base.push(letter);
        }
    }
    return base;
 ...
 */
function validateAlphanumeric(cnpj) {
    const digits = convertCnpj(cnpj.length === constants_1.CNPJ_LENGTH ? cnpj.slice(0, 12) : cnpj);
